...
class MemberArea extends BaseController
{
    ...
    public function getAllKelas()
    {
        ...
        $db = db_connect();
        $kelas = $db->query("SELECT b.nama_kelas, DATE_FORMAT(b.tgl_mulai, '%d-%M-%Y') as tgl_mulai, b.fk_id_program, c.nama_program, a.id_kelas_member, c.image, c.deskripsi, b.id_kelas, a.sertifikat FROM kelas_member as a JOIN kelas as b ON a.fk_id_kelas = b.id_kelas JOIN program as c ON b.fk_id_program = c.id_program WHERE a.hapus = 0 AND a.fk_id_member = $id_member")->getResultArray();
